      ...
      <div>
        ...
        <NavLink style={{ textDecoration: "none" }} to={`/`}>
          <button
            ...
            color="none"
          >
          <img src="https://static.vecteezy.com/system/resources/previews/015/078/042/original/continue-shopping-glyph-icon-vector.jpg" className="img-fluid" width="40px"/> Continue Shoping
          </button>
        </NavLink>
      </div>
    </>
